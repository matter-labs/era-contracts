...
import {IBridgehub, L2TransactionRequestTwoBridgesInner, L2TransactionRequestDirect} from "./interfaces/IBridgehub.sol";

import {L2_NATIVE_TOKEN_VAULT, L2_ASSET_ROUTER, TWO_BRIDGES_MAGIC_VALUE} from "../L2ContractHelper.sol";
...
abstract contract AssetRouterBase is IAssetRouterBase, Ownable2StepUpgradeable, PausableUpgradeable {
    ...
    function setAssetHandlerAddress(bytes32 _assetData, address _assetHandlerAddress) external virtual {
        address sender = msg.sender == address(nativeTokenVault) ? address(L2_NATIVE_TOKEN_VAULT) : msg.sender;
    ...
    function _requestToBridge(
        ...
        request = L2TransactionRequestTwoBridgesInner({
            ...
            l2Contract: address(L2_ASSET_ROUTER),
