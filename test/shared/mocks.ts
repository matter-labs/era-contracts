...
import type { MockContract } from "../../typechain-types";
import { MockContract__factory } from "../../typechain-types";
...
const TEST_SYSTEM_CONTRACTS_MOCKS = {
  ...
  L2EthToken: TEST_ETH_TOKEN_SYSTEM_CONTRACT_ADDRESS,
...
export function getMock(contractName: string): MockContract {
  ...
  return MockContract__factory.connect(address, getWallets()[0]);
}
