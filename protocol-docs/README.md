...
| [ecosystem-upgrade-coordination.md](./ecosystem-upgrade-coordination.md) | The upgrade coordinator (`EcosystemUpgradeExecutor`): the operation commitment, the three stages, domain reservation and authorization, abandonment. The architecture around it is `docs/registry-driven-upgrades.md` |
