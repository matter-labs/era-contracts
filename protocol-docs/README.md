...
| [atomic-interop.md](./atomic-interop.md)   | Atomic multi-leg interop flows: IMT commitments, `flowId`/`commitValue`, finalize and timeout proofs, refund/recovery semantics                                |
