...
| [l1-request-migration.md](./l1-request-migration.md) | Deprecation of the Bridgehub L1→L2 request surface in favour of the `L1InteropCenter`: replacements, renames, authorization changes                                                 |
