...
export interface AccountCodeStorageInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getCodeHash"
      | "getCodeSize"
...
export interface AccountCodeStorage extends BaseContract {
  connect(runner?: ContractRunner | null): AccountCodeStorage;
  waitForDeployment(): Promise<this>;

  interface: AccountCodeStorageInterface;
