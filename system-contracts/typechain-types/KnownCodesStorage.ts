...
export interface KnownCodesStorageInterface extends Interface {
  getFunction(
...
export interface KnownCodesStorage extends BaseContract {
  connect(runner?: ContractRunner | null): KnownCodesStorage;
  waitForDeployment(): Promise<this>;

  interface: KnownCodesStorageInterface;
