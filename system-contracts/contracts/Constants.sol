...
uint256 constant MAX_ALLOWED_PUBDATA_PER_BATCH = 1_560_000;
...
/// While formally a tree of any length is acceptable, the node supports only a constant length of 12288 leaves.
uint256 constant L2_TO_L1_LOGS_MERKLE_TREE_LEAVES = 12_288;
