...
/// @dev The server has a hardcoded chainId (0) which is updated to the real value in the L2GenesisUpgradeTxs.
/// Chain ID 0 is used as a sentinel "uninitialized" value: L1 Bridgehub already rejects chain ID 0 via ZeroChainId,
/// so it can never be a real deployed chain.
...
uint256 constant HARD_CODED_CHAIN_ID = 0;
