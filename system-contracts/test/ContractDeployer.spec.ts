...
describe("ContractDeployer tests", function () {
  ...
  describe("createEVM", function () {
    ...
    it("non system call failed", async () => {
      const deployableArtifactInitCode =
      ...
      await expect(contractDeployer.createEVM(deployableArtifactInitCode)).to.be.revertedWithCustomError(
        contractDeployer,
        "SystemCallFlagRequired"
      );
    });
    ...
    it("successfully deployed", async () => {
      const deployableArtifactInitCode =
        "";
      await expect(contractDeployerSystemCall.createEVM(deployableArtifactInitCode, { gasLimit: 20000000 })).to.emit(
        contractDeployer,
        "ContractDeployed"
      );
    });
