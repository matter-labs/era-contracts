...
describe("DefaultAccount tests", function () {
  ...
  const INTEROP_ACCOUNT_ADDRESS = ethers.utils.getAddress("0x0000000000000000000000000000000000010008");
  ...
  before(async () => {
    ...
    await deployContractOnAddress(
      ...
      "InteropHandler",
      undefined,
      INTEROP_HANDLER_ARTIFACT
    );
    const interop_handler = new zksync.Contract(TEST_L2_INTEROP_HANDLER_ADDRESS, INTEROP_HANDLER_ARTIFACT.abi, wallet);
