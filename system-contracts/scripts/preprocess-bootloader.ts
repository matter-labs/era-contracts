...
const params = {
  ...
  RIGHT_PADDED_IS_ACCOUNT_DELEGATED_SELECTOR: getPaddedSelector("AccountCodeStorage", "isAccountDelegated"),
  DELEGATE_TX_SELECTOR: getSelector("AccountCodeStorage", "delegateTx"),
