...
const params = {
  ...
  RIGHT_PADDED_IS_ACCOUNT_EOA_SELECTOR: getPaddedSelector("AccountCodeStorage", "isAccountEOA"),
  RIGHT_PADDED_PROCESS_DELEGATIONS_SELECTOR: getPaddedSelector("AccountCodeStorage", "processDelegations"),
