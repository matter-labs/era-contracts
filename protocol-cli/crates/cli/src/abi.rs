...
abigen!(
    ChainTypeManagerAbi,
    "../../../l1-contracts/zkstack-out/IChainTypeManagerForZKStack.sol/IChainTypeManagerForZKStack.json",
    event_derives(serde::Deserialize, serde::Serialize)
);

abigen!(
    ValidatorTimelockAbi,
    "../../../l1-contracts/zkstack-out/IValidatorTimelockForZKStack.sol/IValidatorTimelockForZKStack.json",
    event_derives(serde::Deserialize, serde::Serialize)
);
...
abigen!(
    ...
    "../../../l1-contracts/zkstack-out/GatewayVotePreparation.s.sol/GatewayVotePreparation.json",
    event_derives(serde::Deserialize, serde::Serialize)
);
