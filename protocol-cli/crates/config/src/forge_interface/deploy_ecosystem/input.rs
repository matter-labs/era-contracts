...
use protocol_cli_types::{L1Network, ProtocolSemanticVersion, VMOption, u256_to_h256};

use crate::{
    consts::INITIAL_DEPLOYMENT_FILE,
    traits::{FileConfigTrait, FileConfigWithDefaultName},
    ContractsConfigForDeployERC20, GenesisConfig, ERC20_DEPLOYMENT_FILE,
};
        ...
        match vmoption {
            ...
            VMOption::ZKSyncOsVM => {
                ...
                Ok(Self {
                    ...
                    protocol_version: raw.0.get("genesis_protocol_semantic_version")?, // TODO: !!!
                })
            }
        }
    }
