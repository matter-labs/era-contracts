...
export function calculateWethAddresses(l2GovernorAddress:string, l1WethBridgeAddress:string, l1WethAddress:string) :{l2WethImplAddress: string, l2WethProxyAddress: string, l2WethBridgeProxyAddress: string}{
...
export function calculateERC20Addresses(l2GovernorAddress:string, erc20Bridge:L1ERC20Bridge,) :{l2TokenFactoryAddr: string, l2ERC20BridgeProxyAddr: string}{
    const abiCoder = new ethers.utils.AbiCoder();
