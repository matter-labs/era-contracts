...
/// this contract is a copy of the openzeppelin Initializable.sol contract, with storage at random locationsop
...
abstract contract VersionTracker {
    ...
    function _getInitializing() internal view returns (bool _initializing) {
        assembly {
            _initializing := sload(INITIALIZING_ADDRESS)
        }
        return _initializing;
    }

    function _setInitializing(bool _initializing) private {
        assembly {
            sstore(INITIALIZING_ADDRESS, _initializing)
        }
    }
    ...
    modifier onlyInitializing() {
        require(_getInitializing(), "Initializable: contract is not initializing");
        _;
    }
