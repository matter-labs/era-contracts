...
> **On this branch:** `regen-and-verify-stage.sh` was removed with the EraVM cut. The review
> methodology below is unaffected; regenerate with the protocol-ops subcommands
> (`ecosystem upgrade-prepare-all`, `ecosystem verify-upgrade`) instead of that wrapper.
