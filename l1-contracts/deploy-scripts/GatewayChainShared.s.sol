...
abstract contract GatewayChainShared is Script {
    ...
    function getConfigFromL1(
        address _bridgehub, 
        address _gatewayChainId
    ...
    function _prepareGatewayGovernanceCalls(
        ...
        {
            calls = Utils.appendCall(calls, Call({
        ...
        // Confirmed that the L2 Bridgehub should be an asset handler for the assetId for chains.
        {
            ...
            calls = Utils.mergeCalls(calls, Utils.prepareGovernanceL1L2TwoBridgesTransaction(
                _l1GasPrice,
                Utils.MAX_PRIORITY_TX_GAS,
                config.gatewayChainId,
                config.bridgehub,
        ...
        // chains that migrate from L1.
        {
            ...
            calls = Utils.mergeCalls(calls, Utils.runGovernanceL1L2TwoBridgesTransaction(
                _l1GasPrice,
                Utils.MAX_PRIORITY_TX_GAS,
                config.gatewayChainId,
                config.bridgehub,
