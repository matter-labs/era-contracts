...
library Utils {
    ...
    function chainAdminMulticall(address payable _chainAdmin, address _target, bytes memory _data, uint256 _value) internal {
        ChainAdmin chainAdmin = ChainAdmin(_chainAdmin);
