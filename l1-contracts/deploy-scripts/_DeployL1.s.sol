...
contract _DeployL1Script is Script {
    ...
    address internal ADDRESS_ONE = 0x0000000000000000000000000000000000000001;
    address internal DETERMINISTIC_CREATE2_ADDRESS = 0x4e59b44847b379578588920cA78FbF26c0B4956C;
    ...
    function _run() public {
        ...
        _deployGovernance();
        _deployTransparentProxyAdmin();
        _deployBridgehubContract();
        _deployBlobVersionedHashRetriever();
        _deployStateTransitionManagerContract();
        _setStateTransitionManagerInValidatorTimelock();

        _deployDiamondProxy();

        _deploySharedBridgeContracts();
    ...
    function _getBridgehubProxyAddress() public view returns (address) {
        return addresses.bridgehub.bridgehubProxy;
    }

    function _getSharedBridgeProxyAddress() public view returns (address) {
        return addresses.bridges.sharedBridgeProxy;
    }

    function _getBridgehubStateTransitionProxy() public view returns (address) {
        return addresses.stateTransition.stateTransitionProxy;
    }

    function _getStateTransitionDiamondProxy() public view returns (address) {
    ...
    function _instantiateCreate2Factory() internal {
    ...
    function _deployIfNeededMulticall3() internal {
    ...
    function _deployDefaultUpgrade() internal {
    ...
    function _deployGenesisUpgrade() internal {
    ...
    function _deployValidatorTimelock() internal {
    ...
    function _deployTransparentProxyAdmin() internal {
    ...
    function _deployBridgehubContract() internal {
    ...
    function _deployBlobVersionedHashRetriever() internal {
    ...
    function _deployStateTransitionManagerContract() internal {
    ...
    function _deployStateTransitionDiamondFacets() internal {
    ...
    function _deployStateTransitionManagerImplementation() internal {
        bytes memory bytecode = abi.encodePacked(
    ...
    function _deployStateTransitionManagerProxy() internal {
    ...
    function _registerStateTransitionManager() internal {
    ...
    function _setStateTransitionManagerInValidatorTimelock() internal {
    ...
    function _deployDiamondProxy() internal {
    ...
    function _deploySharedBridgeImplementation() internal {
        bytes memory bytecode = abi.encodePacked(
    ...
    function _deploySharedBridgeProxy() internal {
    ...
    function _registerSharedBridge() internal {
        Bridgehub bridgehub = Bridgehub(addresses.bridgehub.bridgehubProxy);
        vm.startBroadcast(msg.sender);
    ...
    function _deployErc20BridgeImplementation() internal {
        bytes memory bytecode = abi.encodePacked(
    ...
    function _deployErc20BridgeProxy() internal {
    ...
    function _updateSharedBridge() internal {
    ...
    function _updateOwners() internal {
        vm.startBroadcast(msg.sender);
