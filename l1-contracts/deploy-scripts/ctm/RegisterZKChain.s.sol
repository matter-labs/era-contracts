...
contract RegisterZKChainScript is Script {
    ...
    function getFactoryDeps() internal view returns (bytes[] memory) {
        bytes[] memory factoryDeps = new bytes[](10);
        ...
        factoryDeps[2] = Utils.readFoundryDeployedBytecodeL1("L2AssetTracker.sol", "L2AssetTracker");
        factoryDeps[3] = Utils.readFoundryDeployedBytecodeL1("L2NativeTokenVaultZKOS.sol", "L2NativeTokenVaultZKOS");
        factoryDeps[4] = Utils.readFoundryDeployedBytecodeL1("L2MessageRoot.sol", "L2MessageRoot");
        factoryDeps[5] = Utils.readFoundryDeployedBytecodeL1(
            "UpgradeableBeaconDeployer.sol",
            "UpgradeableBeaconDeployer"
        );
        factoryDeps[6] = Utils.readFoundryDeployedBytecodeL1("L2ChainAssetHandler.sol", "L2ChainAssetHandler");
        factoryDeps[7] = Utils.readFoundryDeployedBytecodeL1("SystemContractProxy.sol", "SystemContractProxy");
        factoryDeps[8] = Utils.readFoundryDeployedBytecodeL1("InteropCenter.sol", "InteropCenter");
        factoryDeps[9] = Utils.readFoundryDeployedBytecodeL1("InteropHandler.sol", "InteropHandler");
        return factoryDeps;
    }
