...
contract RegisterCTM is Script, DeployUtils {
    ...
    function initializeConfigCTM() internal {
    ...
    function registerChainTypeManager() internal {
        ...
        // Ownable2Step ownable = Ownable2Step(bridgehub);
        vm.startBroadcast(msg.sender);
        // vm.broadcast(0x3B30829Eec8c830a9bC8b58785eFE038c9A2Cc91);
        ...
        // vm.broadcast(CTMDeploymentTracker(address(ctmDT)).owner());
