...
abstract contract DeployL1HelperScript is Script, DeployUtils {
    ...
    function getCreationCode(
        ...
        if (!isZKBytecode) {
            ...
            } else if (compareStrings(contractName, "InteropHandler")) {
                return Utils.readZKFoundryBytecodeL1("InteropHandler.sol", "InteropHandler");
            } else if (compareStrings(contractName, "L2AssetTracker")) {
                return Utils.readZKFoundryBytecodeL1("L2AssetTracker.sol", "L2AssetTracker");
