...
- You may need to override `deployNewEcosystemContractsL1` to only deploy the relevant contracts.
...
- Some of the `prepareStage1GovernanceCalls` and `prepareVersionSpecificStage1GovernanceCallsL1` may be overridden and left empty if they are not part of the upgrade.
