...
contract EcosystemUpgrade_v28 is Script, DeployL1Script {
    ...
    function prepareFixedForceDeploymentsData() public view virtual returns (FixedForceDeploymentsData memory data) {
        ...
        data = FixedForceDeploymentsData({
            ...
            bridgehubBytecodeInfo: abi.encode(getL2BytecodeHash("Bridgehub")),
            ...
            messageRootBytecodeInfo: abi.encode(getL2BytecodeHash("MessageRoot")),
            chainAssetHandlerBytecodeInfo: abi.encode(getL2BytecodeHash("ChainAssetHandler")),
