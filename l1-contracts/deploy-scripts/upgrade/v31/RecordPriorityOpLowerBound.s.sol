...
/// @notice Records a ZKsync OS chain's priority-op lower bound ahead of its v33 upgrade.
/// @dev The upgrade requires a recorded bound and all priority ops below it processed (see
/// `V33UpgradeZKsyncOS`), so this must run in a transaction well before the chain's
