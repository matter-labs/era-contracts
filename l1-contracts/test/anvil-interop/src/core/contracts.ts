...
const ARTIFACTS = {
  ...
  ServerNotifier: "ServerNotifier.sol/ServerNotifier.json",
  V32UpgradePreconditionChecker: "V32UpgradePreconditionChecker.sol/V32UpgradePreconditionChecker.json",
