...
const ARTIFACTS = {
  ...
  Simulator: "Simulator.sol/Simulator.json",
  IMTFactRecorder: "IMTFactRecorder.sol/IMTFactRecorder.json",
  FlowAssetEscrow: "FlowAssetEscrow.sol/FlowAssetEscrow.json",
  AtomicFlowSwap: "AtomicFlowSwap.sol/AtomicFlowSwap.json",
