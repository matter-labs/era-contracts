...
const ARTIFACTS = {
  ...
  BridgeRegistry: "BridgeRegistry.sol/BridgeRegistry.json",
  ...
  L1ShadowAccount: "L1ShadowAccount.sol/L1ShadowAccount.json",
  ...
  ShadowAccountFactory: "ShadowAccountFactory.sol/ShadowAccountFactory.json",
  StealthSender: "StealthSender.sol/StealthSender.json",
  StealthShadowAccount: "StealthShadowAccount.sol/StealthShadowAccount.json",
