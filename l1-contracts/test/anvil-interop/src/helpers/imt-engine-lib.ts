 ...
 * See {protocol-docs/atomic-interop.md} and {protocol-docs/message-root.md}.
 */
 ...
 * leaf. See {protocol-docs/atomic-interop.md} for the proof semantics.
 */
...
/**
 * Mirror of the Solidity `AtomicFlowPreimage` struct. `legBundleHashes` must be strictly ascending
 * with `legSourceChainIds` positionally aligned; `deadline` is a settlement-layer timestamp.
 */
