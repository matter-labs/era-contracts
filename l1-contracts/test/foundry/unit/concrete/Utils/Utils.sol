...
library Utils {
    ...
    function getUtilsFacetSelectors() public pure returns (bytes4[] memory) {
        ...
        selectors[38] = UtilsFacet.util_setTotalBatchesCommitted.selector;
        selectors[39] = UtilsFacet.util_getBaseTokenGasPriceMultiplierDenominator.selector;
        selectors[40] = UtilsFacet.util_getBaseTokenGasPriceMultiplierNominator.selector;
        return selectors;
    }
