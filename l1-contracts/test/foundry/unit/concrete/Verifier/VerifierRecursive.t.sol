...
import {VerifierRecursiveTest as Verifier} from "solpp/dev-contracts/test/VerifierRecursiveTest.sol";

contract VerifierRecursiveTest is Test {
    ...
    function testMoreThan4WordsRecursiveInput_shouldRevert() public {
        ...
        newRecursiveAggregationInput[newRecursiveAggregationInput.length - 1] = recursiveAggregationInput[recursiveAggregationInput.length - 1];
