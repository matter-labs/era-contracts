...
import {EcosystemUpgrade_v28_1} from "deploy-scripts/upgrade/EcosystemUpgrade_v28_1.s.sol";
...
contract UpgradeIntegrationTest is Test {
    ...
    function setUp() public {
        ecosystemUpgrade = new EcosystemUpgrade_v28_1();
        ecosystemUpgrade.initialize(ECOSYSTEM_INPUT, ECOSYSTEM_OUTPUT);
        ecosystemUpgrade.initializeOther(ECOSYSTEM_INPUT, ECOSYSTEM_OUTPUT);
