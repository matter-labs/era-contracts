...
abstract contract L2InteropNativeTokenSimpleTestAbstract is L2InteropTestUtils {
    function test_requestNativeTokenTransferViaLibrary_SameBaseToken() public {
        ...
        InteropLibrary.sendNative({destinationChainId: destinationChainId, recipient: interopTargetContract, unbundlerAddress: UNBUNDLER_ADDRESS, amount: 100, useFixedFee: false, salt: bytes32(0)});
