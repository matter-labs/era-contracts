...
abstract contract L2Erc20TestAbstract is Test, SharedL2ContractDeployer {
    ...
    function test_requestTokenTransferInterop() public {
        ...
        vm.mockCall(address(L2_SYSTEM_CONTEXT_SYSTEM_CONTRACT), abi.encodeWithSelector(L2_SYSTEM_CONTEXT_SYSTEM_CONTRACT.getSettlementLayerChainId.selector), abi.encode(block.chainid));
