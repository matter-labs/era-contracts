...
abstract contract L2NativeTokenVaultBridgeBurnRegressionTestAbstract is Test, SharedL2ContractDeployer {
    ...
    function test_regression_bridgeBurnBaseTokenAsBridgedTokenCallsBurnMsgValue() external virtual {
        ...
        uint256 totalWithdrawalsBefore = l2NativeTokenVault.interopInfo(baseTokenAssetIdLocal).totalWithdrawalsToL1;
        ...
        uint256 totalWithdrawalsAfter = l2NativeTokenVault.interopInfo(baseTokenAssetIdLocal).totalWithdrawalsToL1;
        assertEq(
