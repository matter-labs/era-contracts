...
import {L2ShadowAccountTestAbstract} from "../l2-tests-abstract/L2ShadowAccountTestAbstract.t.sol";
...
contract L2ShadowAccountL1Test is Test, SharedL2ContractL1Deployer, L2ShadowAccountTestAbstract {
    function test() internal virtual override(SharedL2ContractDeployer, SharedL2ContractL1Deployer) {}

    function setUp() public virtual override(SharedL2ContractDeployer, L2ShadowAccountTestAbstract) {
        L2ShadowAccountTestAbstract.setUp();
    }
