...
import {L2InteropFeesTestAbstract} from "../l2-tests-abstract/L2InteropFeesTestAbstract.t.sol";
...
contract L2InteropFeesL1Test is Test, SharedL2ContractL1Deployer, L2InteropFeesTestAbstract {
    function test() internal virtual override(SharedL2ContractDeployer, SharedL2ContractL1Deployer) {}

    function setUp() public virtual override(SharedL2ContractDeployer, L2InteropFeesTestAbstract) {
        L2InteropFeesTestAbstract.setUp();
    }
