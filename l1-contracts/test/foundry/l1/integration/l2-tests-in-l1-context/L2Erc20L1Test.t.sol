...
import {L2_NATIVE_TOKEN_VAULT_ADDR, L2_TO_L1_MESSENGER_SYSTEM_CONTRACT_ADDR} from "contracts/common/l2-helpers/L2ContractInterfaces.sol";
...
contract L2Erc20L1Test is Test, SharedL2ContractL1Deployer {
    ...
    function test_withdrawTokenNoRegistration() public {
        ...
        // L2->L1 withdrawals go through the InteropCenter as a single indirect asset-router call; the burn
        // auto-registers the fresh native token. No bundle attributes needed (fee defaults to 0).
