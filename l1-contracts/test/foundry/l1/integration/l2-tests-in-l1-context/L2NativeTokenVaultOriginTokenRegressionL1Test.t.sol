...
import {L2NativeTokenVaultOriginTokenRegressionTestAbstract} from "../l2-tests-abstract/L2NativeTokenVaultOriginTokenRegressionTestAbstract.t.sol";

import {StateTransitionDeployedAddresses} from "deploy-scripts/utils/Types.sol";
import {Diamond} from "contracts/state-transition/libraries/Diamond.sol";
import {DeployIntegrationUtils} from "../deploy-scripts/DeployIntegrationUtils.s.sol";

contract L2NativeTokenVaultOriginTokenRegressionL1Test is Test, SharedL2ContractL1Deployer, L2NativeTokenVaultOriginTokenRegressionTestAbstract {
