...
import {L2AssetRouterAttributesEncodingRegressionTestAbstract} from "../l2-tests-abstract/L2AssetRouterAttributesEncodingRegressionTestAbstract.t.sol";
...
/// @title L2AssetRouterAttributesEncodingRegressionL1Test
...
contract L2AssetRouterAttributesEncodingRegressionL1Test is
    Test,
    SharedL2ContractL1Deployer,
    L2AssetRouterAttributesEncodingRegressionTestAbstract
{
    function setUp() public override(SharedL2ContractDeployer, L2AssetRouterAttributesEncodingRegressionTestAbstract) {
        L2AssetRouterAttributesEncodingRegressionTestAbstract.setUp();
    }
