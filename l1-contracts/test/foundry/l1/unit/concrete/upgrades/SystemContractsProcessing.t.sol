...
import {L2EcosystemContract, L2SystemContract} from "deploy-scripts/ecosystem/CoreContract.sol";
...
contract SystemContractsProcessingTest is Test {
    ...
    function test_factoryDependenciesIncludeTheNewBuiltInImplementations() public {
        ...
        L2EcosystemContract[2] memory builtIns = [
            L2EcosystemContract.L2InteropCommitmentTree,
            L2EcosystemContract.AtomicFlowManager
        ];
