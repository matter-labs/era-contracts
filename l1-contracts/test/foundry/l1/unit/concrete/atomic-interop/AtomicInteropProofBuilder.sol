    ...
    function _realInclusionProof(
        ...
        return
            ImtProof({
                ...
                settlementProof: _realFirstPostGenesisBatchSettlementProof({_sourceChainId: _sourceChainId, _batchNumber: batchNumber, _imtRootLeafIndex: ChainBatchRootTree.IMT_END_ROOT_LEAF_INDEX, _imtBegin: imtBegin, _imtEnd: imtEnd, _batchTs: _batchTs, _previousChainRoot: previousChainRoot, _slBlock: slBlock}),
    ...
    function _realTimeoutBeginProof(
        ...
        return
            ImtProof({
                ...
                settlementProof: _realFirstPostGenesisBatchSettlementProof({_sourceChainId: _sourceChainId, _batchNumber: batchNumber, _imtRootLeafIndex: ChainBatchRootTree.IMT_BEGIN_ROOT_LEAF_INDEX, _imtBegin: imtSnapshot, _imtEnd: imtSnapshot, _batchTs: _batchTs, _previousChainRoot: previousChainRoot, _slBlock: slBlock}),
    ...
    function _realTimeoutEndProof(
        ...
        return
            ImtProof({
                ...
                chainImtRoot: imtSnapshot,
                provesAgainstBeginRoot: false,
                settlementProof: _realFirstPostGenesisBatchSettlementProof({_sourceChainId: _sourceChainId, _batchNumber: batchNumber, _imtRootLeafIndex: ChainBatchRootTree.IMT_END_ROOT_LEAF_INDEX, _imtBegin: imtSnapshot, _imtEnd: imtSnapshot, _batchTs: _batchTs, _previousChainRoot: previousChainRoot, _slBlock: slBlock}),
                leaf: tree.leafAt(lowIndex),
                imtLeafIndex: lowIndex,
                imtProof: tree.merklePath(lowIndex)
            });
