...
contract AirbenderPlonkProofIntegrationTest is Test {
    ...
    /// `airbender_prover_server/Cargo.toml` (`eravm-airbender-verifier-v29.9.1`);
    ...
    function test_airbenderVerifierPlonk_vkHashIsPinned() public view {
        bytes32 expected = 0x504ce7d1f7d85bebbf1a7f357d9c4dc7c9f1aeddff03f8727d74046adffa30da;
