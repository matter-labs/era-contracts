...
contract MockV34UpgradeNativeTokenVault {
...
contract MockV34UpgradeAssetTracker {
...
contract MockV34UpgradeBaseToken {
    uint256 public initCalls;
...
contract L2V34UpgradeUnitTest is Test {
    ...
    L2V34Upgrade internal testUpgrade;
    ...
    function setUp() public {
        ...
        _etchCode(
            L2_NATIVE_TOKEN_VAULT_ADDR,
            address(
                new MockV34UpgradeNativeTokenVault(
                    BASE_TOKEN_ASSET_ID,
                    L1_CHAIN_ID,
    ...
    function test_UpgradeViaComplexUpgrader_LeavesPreV32ContractsAlone() public {
        ...
        L2ComplexUpgrader(L2_COMPLEX_UPGRADER_ADDR).upgrade(
            address(testUpgrade),
            abi.encodeCall(IL2V34Upgrade.upgrade, (false, CTM_DEPLOYER, fixedData, additionalData))
        );

        // AssetTracker: not re-initialized.
        MockV34UpgradeAssetTracker assetTracker = MockV34UpgradeAssetTracker(L2_ASSET_TRACKER_ADDR);
        ...
        MockV34UpgradeNativeTokenVault nativeTokenVault = MockV34UpgradeNativeTokenVault(L2_NATIVE_TOKEN_VAULT_ADDR);
    ...
    function test_UpgradeViaComplexUpgrader_ZKOSLeavesAtomicInteropBuiltInsAlone() public {
        ...
        L2ComplexUpgrader(L2_COMPLEX_UPGRADER_ADDR).upgrade(
            address(testUpgrade),
            abi.encodeCall(IL2V34Upgrade.upgrade, (true, CTM_DEPLOYER, fixedData, additionalData))
        );
