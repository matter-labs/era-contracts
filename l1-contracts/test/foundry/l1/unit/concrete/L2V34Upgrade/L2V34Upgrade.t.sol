...
contract L2V34UpgradeUnitTest is Test {
    ...
    function setUp() public {
        ...
        _etchCode(
            L2_NATIVE_TOKEN_VAULT_ADDR,
            address(new MockV34UpgradeNativeTokenVault(BASE_TOKEN_ASSET_ID, L1_CHAIN_ID, PREDEPLOYED_WETH))
        );
    ...
    function test_UpgradeViaComplexUpgrader_LeavesPreV32ContractsAlone() public {
        ...
        L2ComplexUpgrader(L2_COMPLEX_UPGRADER_ADDR).upgrade(
            address(testUpgrade),
            abi.encodeCall(IL2V34Upgrade.upgrade, (CTM_DEPLOYER, fixedData, additionalData))
        );
