...
contract L1VerifierPlonkCaller {
    L1VerifierPlonk public verifier;

    constructor(L1VerifierPlonk _verifier) {
        verifier = _verifier;
    }
...
contract PlonkVerifierTestTest is Test {
    ...
    function testShouldVerifyWithGas() public {
        ...
        // - Deploy a L1VerifierPlonkCaller contract, which would execute in zkevm context
        // - Call the verify function from the L1VerifierPlonkCaller contract and return the gas used

        L1VerifierPlonkCaller caller = new L1VerifierPlonkCaller(verifier);
