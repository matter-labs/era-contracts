...
contract GatewayCTMDeployerTest is Test {
    ...
    function _predeployContracts() internal {
        ...
        new TestnetVerifier(L1VerifierFflonk(address(0)), L1VerifierPlonk(address(0)), L1VerifierPlonk(address(0)));
        new DualVerifier(L1VerifierFflonk(address(0)), L1VerifierPlonk(address(0)), L1VerifierPlonk(address(0)));
