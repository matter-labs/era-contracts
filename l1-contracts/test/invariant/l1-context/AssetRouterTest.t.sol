...
import {SharedL2ContractL1Deployer, SystemContractsArgs} from "../../foundry/l1/integration/l2-tests-abstract/_SharedL2ContractL1Deployer.sol";
...
{
    function test() internal virtual override(DeployCTMUtils, SharedL2ContractL1Deployer) {}
