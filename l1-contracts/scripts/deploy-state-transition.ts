...
async function main() {
  ...
  program
    .version("0.1.0")
    .name("deploy-state-manager")
    .description("deploy initial state transition manager contracts");
  ...
  program
    ...
    .action(async (cmd) => {
      ...
      console.log("private-key: ", cmd.privateKey);
      console.log("owner: ", cmd.ownerAddress);
