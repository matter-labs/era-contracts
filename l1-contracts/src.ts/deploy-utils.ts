...
export function deployedAddressesFromEnv(): DeployedAddresses {
  return {
    ...
    Bridges: {
      ...
      L2NativeTokenVaultImplementation: getAddressFromEnv("CONTRACTS_L2_STANDARD_DEPLOYER_IMPL_ADDR"),
      L2NativeTokenVaultProxy: getAddressFromEnv("CONTRACTS_L2_STANDARD_DEPLOYER_PROXY_ADDR"),
