...
export interface DeployedAddresses {
  ...
  Bridges: {
    ...
    L2NonNativeVaultImplementation: string;
    L2NonNativeVaultProxy: string;
...
export function deployedAddressesFromEnv(): DeployedAddresses {
  return {
    ...
    Bridges: {
      ...
      L2NonNativeVaultImplementation: getAddressFromEnv("CONTRACTS_L2_STANDARD_DEPLOYER_IMPL_ADDR"),
      L2NonNativeVaultProxy: getAddressFromEnv("CONTRACTS_L2_STANDARD_DEPLOYER_PROXY_ADDR"),
