...
interface IBridgehub is IL1AssetHandler {
    ...
    event BridgeBurn(uint256 indexed chainId, bytes32 indexed assetId, uint256 indexed settlementLayerChainId);
    ...
    event BridgeMint(uint256 indexed chainId, bytes32 indexed assetId, address indexed hyperchain);
