...
forge script ./contracts/dummy-interop/DeployContracts.s.sol --legacy --ffi --rpc-url=<https://zksync-os-testnet-alpha.zksync.dev/> --slow --skip-simulation --broadcast --private-key=$PRIVATE_KEY --sig "withdrawTokenAndSendBundleToL1(string, string)" $L1_RPC_URL <https://zksync-os-testnet-alpha.zksync.dev/>
