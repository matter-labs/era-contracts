...
contract StateTransitionManager is IStateTransitionManager, ReentrancyGuard, Ownable2Step {
    ...
    /// @dev executes predefined upgrade on chain
    ...
    /// @dev executes arbitrary upgrade on chain
    ...
    function setValidator(uint256 _chainId, address _validator, bool _status) external onlyOwner {
        IZkSyncStateTransition(stateTransition[_chainId]).setValidator(_validator, _status);
    }
