...
interface IMessageVerification {
    ...
    /// @param _batchOrBlockNumber The executed L2 batch/block number in which the message appeared.
    ...
    /// @param _batchOrBlockNumber The executed L2 batch/block number in which the log appeared.
    ...
    /// @param _batchOrBlockNumber The batch/block number of the leaf to be proven.
