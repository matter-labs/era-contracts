...
contract AtomicFlowManager is IAtomicFlowManager {
    ...
    function _recoverBundle(bytes32 _flowId, bytes32 _bundleHash, InteropBundle memory _bundle) internal {
        ...
        // append-only L1 deposit/withdrawal counters ({L2NativeTokenVault.interopInfo} and
        // {BaseTokenHolder.baseTokenInteropInfo}), which only L1-destined flows may touch — and only at send
