...
/// @dev This release's upgrade for ZKsync OS chains, i.e. for a chain moving from v31. Handles
/// IComplexUpgrader.forceDeployAndUpgradeUniversal(UniversalContractUpgradeInfo[], address, bytes).
/// @custom:security-contact security@matterlabs.dev
contract ZKsyncOSSettlementLayerV32Upgrade is SettlementLayerV32UpgradeBase {
