...
contract UpgradeHyperchains is BaseZkSyncUpgrade {
    ...
    function upgrade(ProposedUpgrade calldata _proposedUpgrade) public override returns (bytes32) {
        (uint256 chainId, address bridgehubAddress, address stateTransitionManager, address sharedBridgeAddress, address chainAdmin, address validatorTimelock) = abi
            .decode(_proposedUpgrade.postUpgradeCalldata, (uint256, address, address, address, address, address));
