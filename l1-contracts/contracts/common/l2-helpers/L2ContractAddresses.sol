...
/// @dev Besides separation of concerns, we need it as a separate contract to ensure that L2NativeTokenVault
...
/// deterministic addresses and must be restricted on a settlement layer to prevent unauthorized deployments.
