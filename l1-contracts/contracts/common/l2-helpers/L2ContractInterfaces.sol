...
import {SYSTEM_HOOKS_OFFSET, BUILT_IN_CONTRACTS_OFFSET, L1_MESSENGER_HOOK, SET_BYTECODE_ON_ADDRESS_HOOK, MINT_BASE_TOKEN_HOOK, MAX_BUILT_IN_CONTRACT_ADDR, L2_BOOTLOADER_ADDRESS, L2_ACCOUNT_CODE_STORAGE_ADDR, L2_KNOWN_CODE_STORAGE_SYSTEM_CONTRACT_ADDR, L2_DEPLOYER_SYSTEM_CONTRACT_ADDR, L2_FORCE_DEPLOYER_ADDR, L2_TO_L1_MESSENGER_SYSTEM_CONTRACT_ADDR, MSG_VALUE_SYSTEM_CONTRACT, L2_BASE_TOKEN_SYSTEM_CONTRACT_ADDR, L2_SYSTEM_CONTEXT_SYSTEM_CONTRACT_ADDR, L2_PUBDATA_CHUNK_PUBLISHER_ADDR, L2_COMPRESSOR_ADDR, L2_COMPLEX_UPGRADER_ADDR, L2_CREATE2_FACTORY_ADDR, L2_GENESIS_UPGRADE_ADDR, L2_VERSION_SPECIFIC_UPGRADER_ADDR, L2_BRIDGEHUB_ADDR, L2_ASSET_ROUTER_ADDR, L2_NATIVE_TOKEN_VAULT_ADDR, L2_MESSAGE_ROOT_ADDR, SLOAD_CONTRACT_ADDR, L2_WRAPPED_BASE_TOKEN_IMPL_ADDR, L2_INTEROP_ROOT_STORAGE_ADDR, L2_MESSAGE_VERIFICATION_ADDR, L2_CHAIN_ASSET_HANDLER_ADDR, L2_NTV_BEACON_DEPLOYER_ADDR, L2_SYSTEM_CONTRACT_PROXY_ADMIN_ADDR, L2_INTEROP_CENTER_ADDR, L2_INTEROP_HANDLER_ADDR, L2_ASSET_TRACKER_ADDR, GW_ASSET_TRACKER_ADDR, L2_BASE_TOKEN_HOLDER_ADDR} from "./L2ContractAddresses.sol";
