...
contract L1NativeTokenVault is IL1NativeTokenVault, IL1AssetHandler, NativeTokenVaultBase {
    ...
    /// @dev NOTE: known issue — beyond the underflow guard in `_handleBridgeFromChain`, nothing
    /// currently consumes this accounting; it is written and maintained here for future use.
