    ...
    function processLogsAndMessages(
        ...
        for (uint256 logCount = 0; logCount < logsLength; ++logCount) {
            ...
            if (log.sender == L2_BOOTLOADER_ADDRESS) {
                ...
                } else if (log.key == bytes32(uint256(uint160(L2_BASE_TOKEN_HOLDER_ADDR)))) {
