...
import {L2_BASE_TOKEN_HOLDER_ADDR, L2_BASE_TOKEN_SYSTEM_CONTRACT, L2_BRIDGEHUB, L2_CHAIN_ASSET_HANDLER, L2_COMPLEX_UPGRADER_ADDR, L2_NATIVE_TOKEN_VAULT, L2_NATIVE_TOKEN_VAULT_ADDR, L2_SYSTEM_CONTEXT_SYSTEM_CONTRACT} from "../../common/l2-helpers/L2ContractInterfaces.sol";
...
contract L2AssetTracker is AssetTrackerBase, IL2AssetTracker {
    ...
    function handleInitiateBaseTokenBridgingOnL2(uint256 _amount) external onlyBaseTokenHolder {
