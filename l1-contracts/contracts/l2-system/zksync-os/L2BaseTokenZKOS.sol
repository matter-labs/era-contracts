...
contract L2BaseTokenZKOS is L2BaseTokenBase, IL2BaseTokenZKOS {
    ...
    /// this slot backfilled by the v31 service transaction, and the v33 upgrade is forbidden
    /// on L1 until that happened (see `V33UpgradeZKsyncOS`), so the value here is
