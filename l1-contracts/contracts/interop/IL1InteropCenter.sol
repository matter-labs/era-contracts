...
/// @param l2GasPerPubdataByteLimit The maximum amount of L2 gas that the operator may charge per pubdata byte.
...
interface IL1InteropCenter is IERC7786GatewaySource {
    /// @notice The L1 Bridgehub that the requests are relayed to.
