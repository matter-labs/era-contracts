...
interface IERC7786Attributes {
    ...
    /// @notice Routes the call through a ShadowAccount on the destination chain.
    /// @dev When present, the InteropHandler deploys (if needed) a ShadowAccount for the sender
