...
interface IERC7786Attributes {
    ...
    /// @param _flowPreimage The full `flowId` preimage: the flow's deadline (a settlement-layer
    ///      timestamp), settlement layer chain id, leg bundle hashes (strictly ascending) and their
