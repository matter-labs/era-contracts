...
use crate::abi::{
    ...
    ICTMUPGRADEV31ABI_ABI, ICOREUPGRADEV31ABI_ABI, IDEPLOYCTMABI_ABI, IDEPLOYL2CONTRACTSABI_ABI,
    IDEPLOYPAYMASTERABI_ABI, IENABLEEVMEMULATORABI_ABI, IFINALIZECHAININITABI_ABI,
    IGATEWAYVOTEPREPARATIONABI_ABI, IREGISTERCTMABI_ABI, IREGISTERONALLCHAINSABI_ABI,
    IREGISTERZKCHAINABI_ABI, ISETUPLEGACYBRIDGEABI_ABI, IUPGRADEV31ABI_ABI,
};
...
lazy_static! {
    ...
    pub static ref CORE_UPGRADE_V31_CONTRACT: BaseContract =
        BaseContract::from(ICOREUPGRADEV31ABI_ABI.clone());
    pub static ref CTM_UPGRADE_V31_CONTRACT: BaseContract =
        BaseContract::from(ICTMUPGRADEV31ABI_ABI.clone());
