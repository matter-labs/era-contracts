...
use xshell::Shell;
use protocol_ops_common::contracts::{encode_ntv_asset_id};
use protocol_ops_common::system_contracts::{L2_ASSET_ROUTER_ADDRESS, L2_NATIVE_TOKEN_VAULT_ADDRESS};
use protocol_ops_types::{L1Network, VMOption};
...
impl CoreContractsConfig {
    ...
    pub fn bridgehub_proxy_addr(&self) -> Address {
        self.core_ecosystem_contracts.bridgehub_proxy_addr
    }

    pub fn ctm_proxy_addr(&self, vm_option: VMOption) -> Address {
        self.ctm(vm_option).state_transition_proxy_addr
    }
        ...
        ContractsConfig {
            ...
            l1: L1Contracts {
                ...
                base_token_asset_id: Some(encode_ntv_asset_id(
                    l1_network.chain_id().into(),
                    chain_params.base_token_addr,
                )),
