...
use protocol_ops_config::forge_interface::deploy_ctm::output::DeployCTMOutput;
use protocol_ops_types::VMOption;
...
pub async fn ctm_init(
    ...
    forge_args: &protocol_ops_common::forge::ForgeScriptArgs,
    l1_rpc_url: &str,
    input: &CtmInitInput,
